...
class MDBRepository:
    ...
    def execute_query(self, query: str, params: tuple = ()) -> List[Dict[str, Any]]:
        # logger.debug("Executing MDB query", query=query, params=params)
        try:
            # Note: On Linux, this might fail if drivers aren't installed.
            # But the requirement says sync worker runs natively on Windows.
